...
if ( class_exists( 'WP_List_Table_Helper' ) and ! class_exists( 'Wpgmp_Location_Table' ) ) {
	...
	'bulk_actions' => array ( 'export_location_csv' => 'Export as CSV', 'export_location_json' => 'Export as JSON', 'export_location_xml' => 'Export as XML' , 'export_location_excel' => 'Export as Excel' ),
