...
if (class_exists('WPBakeryVisualComposerAbstract')) {
    return array(
        'id'          => 'jkreativ_page_landing_vc',
        'types'       => array('page'),
        'title'       => 'Jkreativ Landing Page Setting & Header',
        'priority'    => 'high',
        'template'    => array(
            ...
            array(
                'type' => 'notebox',
                'name' => 'nb_position',
                'label' => 'Navigation Position (Only if you choose to use top navigation)',
                'status' => 'info',
            ),
            ...
            array(
                ...
                'description' => 'Put Navigation on the bottom of heading (Only if you choose to use top navigation)',
            ),
            ...
            array(
                ...
                'description' => 'choose slider that you have create previously from landing slider',
                'allowsingle' => true,
                'default' => '{{first}}',
                'dependency' => array(
                    'field'    => 'heading_type',
