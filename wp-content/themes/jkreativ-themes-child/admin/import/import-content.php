...
function jeg_set_widget()
{
    ...
    jeg_add_widget_to_sidebar( JEG_DEFAULT_WIDGET , 'jeg_facebook_fans_widget', 1, array('title' => 'Like us on Facebook', 'facebookurl' => "https://www.facebook.com/opendoorbrewco"));
